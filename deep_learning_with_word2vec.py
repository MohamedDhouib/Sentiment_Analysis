# -*- coding: utf-8 -*-
"""Deep_learning_with_Word2Vec.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1utubmMJuwm1UzieJ1SkF7EGa5Sf79XyZ
"""
...
ORIGINAL_DATA_FOLDER = os.path.join(DATA_ROOT)

train_data_path = os.path.join(ORIGINAL_DATA_FOLDER, 'data_base.csv')
...
texts = list(train_df['Phrase'].values)
...
full_text = list(train_df['Phrase'].values)
